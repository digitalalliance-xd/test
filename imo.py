...
USN="Mozilla/5.0 (Linux; Android 7.0; SM-J530FM Build/NRD90M; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/65.0.3325.109 Mobile Safari/537.36 Instagram 41.0.0.13.92 Android (24/7.0; 320dpi; 720x1280; samsung; SM-J530FM; j5y17lte; samsungexynos7870; ru_RU; 103516660)"
...
def user_agent():
	...
	versions = ['SM-G955N', 'SM-N950F', 'SM-N9005', 'SM-G955N']
...
{K}┣[>] STATUS :  CP
  ...
  ┣Postingan: {postingan}{C}
	...
	def menu(self):
		...
		if c=='':
			...
			info=self.infoAPI(self.cookie,'https://i.instagram.com/api/v1/friendships/%s/following/?count=1000000',id)
 ...
 [{M}+{C}] {M}CHECKPOINT LOGIN{C}:
  ...
  {H}[>]{C}{H} Mengikuti : {H}{ful}{C}
			...
			back=self.infoAPI(self.cookie,'https://i.instagram.com/api/v1/friendships/%s/following/?count=1000000',x_id)
			for i in following:
				six+=1
